...
- Launch assets under `docs/assets/launch/` (Product Hunt image, icon, 1080p launch video)
  and `docs/assets/demo.mp4`, generated by `scripts/launch/make_launch.py`; a Media page
  on the docs site.
